...
MRB_API mrb_value mrb_obj_iv_get(mrb_state *mrb, struct MRObject *obj, mrb_sym sym);
MRB_API void mrb_obj_iv_set(mrb_state *mrb, struct MRObject *obj, mrb_sym sym, mrb_value v);
MRB_API mrb_bool mrb_obj_iv_defined(mrb_state *mrb, struct MRObject *obj, mrb_sym sym);
MRB_API void mrb_obj_iv_ifnone(mrb_state *mrb, struct MRObject *obj, mrb_sym sym, mrb_value v);
...
mrb_value mrb_obj_iv_inspect(mrb_state*, struct MRObject*);
...
void mrb_gc_mark_iv(mrb_state*, struct MRObject*);
size_t mrb_gc_mark_iv_size(mrb_state*, struct MRObject*);
void mrb_gc_free_iv(mrb_state*, struct MRObject*);
